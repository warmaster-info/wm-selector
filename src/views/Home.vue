<template>
  <main class="home-view">
    ...
    <ArmyListAccordion :title="'Warmaster Revolution'" :subtitle="'v2.26'">
      <a target="_blank" title="Warmaster Revolution Rules" href="https://warmaster.info/en/revolution/rules/"><span>Warmaster Revolution Compendium</span></a>
      <a target="_blank" title="Warmaster Revolution Armies" href="https://warmaster.info/en/revolution/armies/"><span>Warmaster Revolution Armies</span></a>
    </ArmyListAccordion>

    <ArmyListAccordion :title="'Warmaster Revolution Experimental'">
      <a target="_blank" title="Warmaster Revolution Experimental Units" href="https://warmaster.info/en/revolution/experimental-units/"><span>Warmaster Revolution Experimental Units</span></a>
    </ArmyListAccordion>
