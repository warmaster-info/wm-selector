<template>
  <main class="home-view">
    ...
    <ArmyListAccordion :title="'Warmaster Revolution'" :subtitle="'v2.26'">
      <a target="_blank" title="Warmaster Revolution Rules" href="/pdfs/WMR 2.1.0.pdf"><span>Warmaster Revolution Compendium</span></a>
      <a target="_blank" title="Warmaster Revolution Armies" href="/pdfs/WMR_Armies2.26.pdf"><span>Warmaster Revolution Armies</span></a>
    </ArmyListAccordion>
